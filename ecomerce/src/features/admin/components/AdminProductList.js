...
import { allproducts,fetchFilteredProductsAsync,selectTotalItems,selectBrands,selectCategories,fetchfiltersCategoriesAsync,fetchfiltersBrandsAsync, fetchallproductsAsync} from "../../product/productSlice";
...
export default function ProductList() {
  ...
  useEffect(()=>{
    ...
    dispatch(fetchFilteredProductsAsync({filter,sort,pagination,admin:true}))
              ...
              {products.map((product) => (
                <div key={product.id}>
                  <Link key={product.id} to={`/product-detail/${product.id}`}>
                    <div key={product.id} className="group relative border-2 border-solid p-2 h-[344px] border-gray-200">
                ...
                <div>
                  <Link 
                      ...
                      type="submit"
                      className="rounded-md mt-2 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Edit Product
                  </Link>
                </div>
